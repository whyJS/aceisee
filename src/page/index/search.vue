<template>
  <div class="aceisee-searchs" @click.self="handleEsc">
    <div class="aceisee-searchs__title">菜单搜索</div>
    <div class="aceisee-searchs__content">
      <div class="aceisee-searchs__form">
        <el-input
      ...
      <div class="aceisee-searchs__list">
        <el-scrollbar class="aceisee-searchs__scrollbar">
          <div
            class="aceisee-searchs__item"
            v-for="(item, index) in menus"
            :key="index"
            @click="handleSelect(item)"
          >
            <i :class="[item[iconKey], 'aceisee-searchs__item-icon']"></i>
            <span class="aceisee-searchs__item-title">{{
              item[labelKey]
            }}</span>
            <div class="aceisee-searchs__item-path">
              {{ item[pathKey] }}
            </div>
          </div>
        </el-scrollbar>
